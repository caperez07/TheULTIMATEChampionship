...
{
    public class CharactersTableInitializer
    {
        private readonly ProjectContext _dbContext;
        public CharactersTableInitializer(ProjectContext dbContext) 
        { 
        ...
        public void Initialize()
        {
            ...
            characters.Add(new Characters { Name = "Sonic", Age = 15, Power = 37, Fights = 668, Defeat = 101, Victory = 567 });
            characters.Add(new Characters { Name = "Olimar", Age = 18, Power = 90, Fights = 785, Defeat = 83, Victory = 702 });
            characters.Add(new Characters { Name = "Lucas", Age = 10, Power = 56, Fights = 477, Defeat = 450, Victory = 27 });
            characters.Add(new Characters { Name = "Wii Fit Trainer", Age = 28, Power = 79, Fights = 504, Defeat = 27, Victory = 477 });
